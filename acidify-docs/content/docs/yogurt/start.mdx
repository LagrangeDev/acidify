...
[![npm](https://img.shields.io/npm/v/%40acidify%2Fyogurt?style=flat-square)](https://www.npmjs.com/package/@acidify/yogurt)
...
Docker 部署方案由社区项目维护。详细说明请在 [`shoucandanghehe/yogurt-docker`](https://github.com/shoucandanghehe/yogurt-docker) 仓库查看。
