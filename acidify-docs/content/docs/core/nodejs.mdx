...
[![npm](https://img.shields.io/npm/v/%40acidify%2Fcore?style=flat-square)](https://www.npmjs.com/package/@acidify/core)
...
const signProvider = new LagrangeUrlSignProvider(scope, /* url, token, uin 等参数 */);
...
更多的使用说明请参考[在 Kotlin 中使用](./kotlin.mdx)。
